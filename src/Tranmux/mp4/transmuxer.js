...
_Transmuxer = function Transmuxer(options) {
  ...
  this.setupAacPipeline = function () {
    ...
    pipeline.aacStream.pipe(pipeline.timedMetadataTimestampRolloverStream)
    .pipe(pipeline.metadataStream).pipe(pipeline.coalesceStream);
  ...
  this.setupTsPipeline = function () {
    ...
    pipeline.timestampRolloverStream.pipe(pipeline.metadataStream)
      ...
      if (data.type === 'metadata') {
        ...
        if (videoTrack && !pipeline.videoSegmentStream) {
          ...
          pipeline.videoSegmentStream.on('timelineStartInfo', function (timelineStartInfo) {
            ...
            // because this is a particularly subtle form setosf timestamp alteration.
